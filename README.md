...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-bcf--client-green.svg)](https://anaconda.org/freecad/bcf-client) | [![Conda Downloads](https://img.shields.io/conda/dn/freecad/bcf-client.svg)](https://anaconda.org/freecad/bcf-client) | [![Conda Version](https://img.shields.io/conda/vn/freecad/bcf-client.svg)](https://anaconda.org/freecad/bcf-client) | [![Conda Platforms](https://img.shields.io/conda/pn/freecad/bcf-client.svg)](https://anaconda.org/freecad/bcf-client) |
...
Installing `bcf-client` from the `freecad` channel can be achieved by adding `freecad` to your channels with:
...
Once the `freecad` channel has been enabled, `bcf-client, ifcopenshell` can be installed with `conda`:
...
```
conda search bcf-client --channel freecad
```

or with `mamba`:

```
mamba search bcf-client --channel freecad
```
...
mamba repoquery search bcf-client --channel freecad

# List packages depending on `bcf-client`:
mamba repoquery whoneeds bcf-client --channel freecad

# List dependencies of `bcf-client`:
mamba repoquery depends bcf-client --channel freecad
```
